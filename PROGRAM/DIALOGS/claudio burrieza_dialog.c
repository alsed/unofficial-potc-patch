...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "quests":
			...
			{
				link.l2 = DLG_TEXT[29] + characters[GetCharacterIndex(DLG_TEXT[30])].name + " " + characters[GetCharacterIndex(DLG_TEXT[30])].lastname + DLG_TEXT[32];
			...
			{
				link.l5 = DLG_TEXT[29] + characters[GetCharacterIndex(DLG_TEXT[31])].name + " " + characters[GetCharacterIndex(DLG_TEXT[31])].lastname + DLG_TEXT[38];;
				link.l5.go = "search_ogarrio";
			}
		...
		case "search_ogarrio":
			dialog.text = DLG_TEXT[114] + characters[GetCharacterIndex(DLG_TEXT[31])].lastname + DLG_TEXT[115] + characters[GetCharacterIndex(DLG_TEXT[31])].lastname + DLG_TEXT[116]
			link.l1 = DLG_TEXT[69];
			link.l1.go = "exit";
		break;
