...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "node_6":
			...
			AddQuestRecord("Blaze_search_Rheims", "17");
		break;
		...
		case "third_mission_3":
			dialog.text = DLG_TEXT[164] + pchar.name + DLG_TEXT[235];
		...
		case "fourth_mission_kill_arnaud":
			...
			{
				dialog.text = DLG_TEXT[189] + pchar.name + ".";
		...
		case "fourth_mission_with_officer_to_shop_wrong":
			dialog.text = DLG_TEXT[198] + PChar.name + DLG_TEXT[236];
		...
		case "trap_completed":
			dialog.text = DLG_TEXT[222] + pchar.name + DLG_TEXT[237];
