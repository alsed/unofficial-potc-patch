...
#define str2	"You must choose"
#define str3  "surrendered men"
...
void InitInterface_RR(string iniName,ref myCh,ref enemyCh)
{
	...
	CreateString(TRUE,"String3", nSurrenderedMen+" " + XI_ConvertString(str3),FONT_NORMAL,COLOR_NORMAL,320,296,SCRIPT_ALIGN_CENTER,1.0);
